...
config.dir = '/home/chronux/cornell/data/lbex_data/loc2010';
fid = 0; [ fid, message ] = fopen( [ config.dir filesep config.filename ], 'w'); 
if fid == -1, error( 'ddConcentration:: ', message ); end
...
fprintf( 1, '   K_inf Singular Values: Relative Min = %g, Leading = %g\n', S( nChannels, nChannels )/S( 1, 1 ), S( 1, 1 ) );
